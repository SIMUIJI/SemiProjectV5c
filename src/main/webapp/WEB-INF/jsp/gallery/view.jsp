...
<div id="main">
    ...
    <div class="row margin1050">
        <table class="table">
            ...
            <tr style="background: #ccff99">
                ...
                <td class="text-right">2012.07.28 16:02:35 / 13</td>
            </tr>
            <tr style="background: #ffffcc">
                <td colspan="2" class="text-left"
                    ...
                    <c:if test="${ not empty g.fname2}">
                        <img src="/resources/img/kitty.png" class="img-fluid"><br></c:if>
                    <c:if test="${ not empty g.fname3}">
                        <img src="/resources/img/sujipopo.jpg" class="img-fluid"><br></c:if>
                </td>
            </tr>
            <tr>
                <td class="text-left">이미지1</td>
                <td>${g.fname1} (123KB)</td>
                <c:if test="${ not empty g.fname2}">
            </tr>
            <tr>
                <td class="text-left">이미지2</td>
                </c:if>
                <td>${g.fname2} (1.3MB)</td>
                <c:if test="${ not empty g.fname3}">
            </tr>
            <tr>
                <td class="text-left">이미지2</td>
                </c:if>
                <td>${g.fname3} (1.3MB)</td>
            </tr>
        </table>
    </div><!-- 본문 -->
    ...
    border-bottom:3px solid black">
            <tr>
                <td style="width:25%" class="text-left"><h4>zzyigy</h4></td>
                <td>
